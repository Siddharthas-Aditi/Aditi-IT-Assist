...
PERMISSION_REGISTRY: list[PermissionDef] = [
    ...
    PermissionDef(
        P.TICKET_READ_TEAM, "Read Team Tickets", Resource.TICKET, Action.READ, Scope.TEAM
    ),
    ...
    PermissionDef(
        P.CHAT_READ_ASSIGNED, "Read Assigned Chats", Resource.CHAT, Action.READ, Scope.ASSIGNED
    ),
    ...
    PermissionDef(
        P.CHAT_END_SESSION, "End Chat Session", Resource.CHAT, Action.END, Scope.ASSIGNED
    ),
    PermissionDef(
        P.CHAT_REQUEST_LIVE_AGENT, "Request Live Agent", Resource.CHAT, Action.REQUEST, Scope.OWN
    ),
    # ── Specialist queue + live chat ──
    PermissionDef(
        P.SPECIALIST_QUEUE_VIEW, "View Specialist Queue", Resource.CHAT, Action.READ, Scope.TEAM
    ),
    PermissionDef(
    ...
    # ── Knowledge ──
    PermissionDef(
        P.KNOWLEDGE_READ, "Read Knowledge Base", Resource.KNOWLEDGE, Action.READ, Scope.ALL
    ),
    PermissionDef(
        P.KNOWLEDGE_CREATE, "Create KB Article", Resource.KNOWLEDGE, Action.CREATE, Scope.NONE
    ),
    PermissionDef(
        P.KNOWLEDGE_UPDATE_OWN,
        "Update Own KB Articles",
        Resource.KNOWLEDGE,
        Action.UPDATE,
        Scope.OWN,
    ),
    ...
    PermissionDef(
        P.KNOWLEDGE_VIEW_ANALYTICS, "View KB Analytics", Resource.KNOWLEDGE, Action.VIEW, Scope.ALL
    ),
    PermissionDef(
        P.KNOWLEDGE_VIEW_INTERNAL,
        "Retrieve Internal/Unpublished KB",
        Resource.KNOWLEDGE,
        Action.READ,
        Scope.ALL,
        audit_required=True,
    ...
    PermissionDef(
        ...
        "Review & Save Ingestion Candidates",
        Resource.KNOWLEDGE,
        Action.UPDATE,
        Scope.ALL,
        audit_required=True,
    ...
    PermissionDef(
        ...
        "Promote KB Improvement Candidate",
        Resource.KNOWLEDGE,
        Action.APPROVE,
        Scope.ALL,
        audit_required=True,
    ...
    PermissionDef(
        P.FEEDBACK_VIEW_OWN, "View Own Feedback", Resource.FEEDBACK, Action.READ, Scope.OWN
    ),
    PermissionDef(
    ...
    PermissionDef(
        ...
        "Read Directory/Device State (Entra/Intune)",
    ...
    PermissionDef(
        ...
        "Read External Tickets (ServiceNow)",
        Resource.INTEGRATION,
        Action.READ,
        Scope.ALL,
        audit_required=True,
    ...
    PermissionDef(
        ...
        "Write Directory Actions (Unlock/Reset MFA)",
        Resource.INTEGRATION,
        Action.UPDATE,
        Scope.ALL,
        audit_required=True,
    ...
    PermissionDef(
        ...
        "Create External Tickets (ServiceNow)",
        Resource.INTEGRATION,
        Action.CREATE,
        Scope.ALL,
        audit_required=True,
    ...
    PermissionDef(
        P.ANALYTICS_VIEW_TEAM, "View Team Analytics", Resource.ANALYTICS, Action.VIEW, Scope.TEAM
    ),
    PermissionDef(
        P.ANALYTICS_VIEW_ALL, "View Global Analytics", Resource.ANALYTICS, Action.VIEW, Scope.ALL
    ),
    PermissionDef(
        P.ANALYTICS_EXPORT,
        "Export Reports",
