...
def downgrade() -> None:
    op.drop_index("ix_knowledge_candidates_review_queue", table_name="knowledge_candidates")
    op.drop_index(
        "ix_knowledge_candidates_issue_subtype",
        table_name="knowledge_candidates",
    )
    op.drop_index("ix_knowledge_candidates_category", table_name="knowledge_candidates")
    op.drop_index(
        "ix_knowledge_candidates_proposed_by_agent",
        table_name="knowledge_candidates",
    )
    ...
    op.drop_index("ix_knowledge_candidates_state", table_name="knowledge_candidates")
    op.drop_index("ix_knowledge_candidates_source", table_name="knowledge_candidates")
